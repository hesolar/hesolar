...
[![My Skills](https://skillicons.dev/icons?i=azure,bootstrap,cs,css,docker,dotnet,github,gitlab,html,java,js,jenkins,jquery,linkedin,,powershell,stackoverflow,,vscode&perline=10)](https://skillicons.dev)
