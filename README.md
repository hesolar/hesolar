...
[![My Skills](https://skillicons.dev/icons?i=visualstudio,dotnet,cs, html,css,js,azure,bootstrap,jenkins,docker,github,gitlab,html,java,jquery,linkedin,powershell,stackoverflow,vscode&perline=10)](https://skillicons.dev)
