...
[![My Skills](https://skillicons.dev/icons?i=visualstudio,dotnet,cs,html,css,js,azure,bootstrap,jenkins,docker,github,gitlab,html,java,jquerylinkedin,powershell,stackoverflow,vscode&perline=20)](https://skillicons.dev)
